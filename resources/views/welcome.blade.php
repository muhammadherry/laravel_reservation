            ...
            <div class=" section-content">
                <div class="row">
                    <div class="col-md-5 col-sm-6">
                        <form class="reservation-form" method="post" action="welcome/create">
                            @csrf
                            <div class="row">
                                ...
                                <div class="form-group col-md-12 col-sm-12">
                                    <select name="status" class="form-control reserve-form empty iconified" id="exampleFormControlSelect1">
