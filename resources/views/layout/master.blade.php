...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <!-- SEARCH FORM -->
    <form class="form-inline ml-3" method="get" action="/msworkflow">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="dropdown">
        <a href=""class="dropdown-toggle"data-toggle="dropdown"><img src="" class="img-circle" alt=""></i>
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <div class="dropdown-divider"></div>
            <a href="#" class="dropdown-item">
              <i class="lnr lnr-envelope"></i> Message
            </a>
            <div class="dropdown-divider"></div>
            <a href="#" class="dropdown-item">
            ...
            <a href="/logout" class="dropdown-item">
              <i class="lnr lnr-exit"></i> Log out
            </a>
        </div>
      </li>
      <li class="nav-item">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          ...
          <ul class="dropdown-menu">
              <li><a href=""><i class="lnr lnr-user">My Profile</i></a></li>
              <li><a href=""><i class="lnr lnr-envelope">Message</i></a></li>
              <li><a href=""><i class="lnr lnr-cog">Setting</i></a></li>
              <li><a href=""><i class="lnr lnr-exit">Log out</i></a></li>
          </ul>
        </div>
      </div>
